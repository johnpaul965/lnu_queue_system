...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildAvatarCard() {
    final name = (_student?['full_name'] ?? 'Student') as String;
    final initials = name
        .trim()
        .split(' ')
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _infoRow(Icons.person_outline, 'Full Name', (_student?['full_name'] ?? '—') as String),
            const Divider(height: 24),
            _infoRow(Icons.badge_outlined, 'Student ID', (_student?['student_id'] ?? '—') as String),
            const Divider(height: 24),
  ...
  Widget _buildAccountCard() {
    final createdAt = _student?['created_at'];
    String joinedDate = '—';
    if (createdAt != null) {
      try {
